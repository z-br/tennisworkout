...
// print route (/plan/:id/print) and the public one (/p/:slug/print) — the
// sheets only need the doc, not where it came from.
  ...
  return (
    <main className="print-root">
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3 px-4 pt-4 print:hidden">
        <Link to={backTo} className="text-sm text-gray-500 hover:underline dark:text-gray-400">
          {backLabel}
        </Link>
